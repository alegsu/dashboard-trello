...
export async function GET() {
  try {
    const users = await prisma.user.findMany({
      orderBy: { name: 'asc' },
      select: { 
        id: true, name: true, email: true, phone: true, role: true, avatarUrl: true, loginCount: true, totalUsageTime: true, usageTimeToday: true, totalActiveTime: true, activeTimeToday: true, theme: true, lastActiveAt: true, lastNotificationEmailSentAt: true,
        _count: {
          select: {
