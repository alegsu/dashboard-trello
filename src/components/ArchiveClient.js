...
export default function ArchiveClient({ initialArchive, clients }) {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '1200px', margin: '0 auto', fontFamily: 'var(--font-sans)', color: 'var(--text-primary)' }}>
      {/* Header */}
      <header className="glass-panel" style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: '1rem', padding: '1rem 1.5rem', borderTop: '3px solid var(--accent-primary)', marginBottom: '2rem', borderRadius: '12px' }}>
        ...
        <div style={{ display: 'flex', gap: '1rem', alignItems: 'center' }}>
          <Link href="/">
             <button style={{ background: 'var(--accent-primary)', color: 'white', border: 'none', borderRadius: '20px', padding: '0.4rem 1rem', cursor: 'pointer', fontWeight: 'bold' }}>
               Torna alla Bacheca
             </button>
          </Link>
        </div>
