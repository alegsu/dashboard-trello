                  ...
                  {project.assignees && project.assignees.length > 0 && (
                    <div style={{ display: 'flex', marginLeft: '0.5rem' }}>
                      {project.assignees.map(a => (
                        <div key={a.id} title={a.name} style={{ width: '22px', height: '22px', borderRadius: '50%', background: 'var(--accent-primary)', color: '#fff', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '0.65rem', fontWeight: 'bold', border: '1px solid var(--bg-primary)', marginLeft: '-6px' }}>
